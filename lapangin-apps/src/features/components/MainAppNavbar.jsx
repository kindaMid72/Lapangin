...
export default function NavBar() {
    ...
    return (
        <ul className="flex flex-wrap gap-4 light:bg-slate-100 items-center dark:bg-slate-900 [&_li]:hover:bg-green-700 [&_li]:cursor-pointer text-[1em] p-2 [&_li]:font-mono [&_li]:text-[1em] rounded-b-xl">
            ...
            <li className={`${selectedMenu === 'dashboard' ? activeClass : inactiveClass} transition-color duration-100 ease-in-out`} onClick={() => handleNavigate('dashboard')}><i className="fa-solid fa-table mr-2 "></i>Dashboard</li>
            <li className={`${selectedMenu === 'bookings' ? activeClass : inactiveClass} transition-color duration-100 ease-in-out`} onClick={() => handleNavigate('bookings')}><i className="fa-solid fa-calendar mr-2 "></i>Bookings</li>
            <li className={`${selectedMenu === 'courts' ? activeClass : inactiveClass} transition-color duration-100 ease-in-out`} onClick={() => handleNavigate('courts')}><i className="fa-solid fa-layer-group mr-2 "></i>Courts</li>
