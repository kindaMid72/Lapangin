    ...
    return (
        ...
        <div className='z-30'>
            ...
            <div className="flex items-center justify-between pt-5 px-6 py-3">
                ...
                <button onClick={() => setShowNewCourtModal(true)} className="border-2 rounded-xl px-3 p-1 bg-green-800 font-extrabold border-transparent cursor-pointer hover:bg-green-700 transition-colors duration-300 ease-in-out">+ Tambah Lapangan</button>
            </div>
